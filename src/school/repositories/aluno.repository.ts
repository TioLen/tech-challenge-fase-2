...
export abstract class AlunoRepository {
    ...
    abstract getAlunosByTurma(turmaId: string, limit: number, page: number): Promise<IAluno[]>;
    abstract updateAluno(alunoId: string, data: Partial<IAluno>): Promise<IAluno | null>;
