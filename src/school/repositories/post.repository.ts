...
export abstract class PostRepository {
    ...
    abstract getPostsByDocente(docenteId: string, limit: number, page: number): Promise<IPost[]>;
    abstract getPostsByStatus(status: 'publicado' | 'rascunho', limit: number, page: number): Promise<IPost[]>;
    abstract updatePost(postId: string, data: Partial<IPost>): Promise<IPost | null>;
